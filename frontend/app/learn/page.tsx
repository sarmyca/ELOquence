      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-2.5 mb-2">
            ...
            <h1 className="font-display font-black text-5xl text-text-primary tracking-tight">
              Learn
            </h1>
          </div>
          <p className="font-sans text-base text-text-secondary leading-relaxed mb-1">
            How ELOquence works — explained in plain English.
          </p>
          <p className="font-sans text-sm text-text-secondary leading-relaxed">
            Have a question about how ELOquence works? You&apos;re in the right place. Everything
            from tile colors to the math behind the bot, written for people who have never heard
